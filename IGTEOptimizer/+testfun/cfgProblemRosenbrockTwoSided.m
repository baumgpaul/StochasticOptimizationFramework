function [problemConfig] = cfgProblemRosenbrockTwoSided
...
problemConfig.membershipFunctions{1}.type='twosided';
problemConfig.membershipFunctions{1}.k = 1;
problemConfig.membershipFunctions{1}.p10 = [-0.3 0.3];
problemConfig.membershipFunctions{1}.p90 = [-0.1 0.1];
